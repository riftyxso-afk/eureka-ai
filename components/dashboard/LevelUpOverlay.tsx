  ...
  return (
    <AnimatePresence>
      {pending && (
        <motion.div
          key={pending.at}
          className="fixed inset-0 z-[80] flex items-center justify-center bg-clay-dark/40 backdrop-blur-[2px]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          ...
          >
            ...
            <motion.div
              className="card-clay mt-6 !bg-white/95 px-10 py-6 text-center"
