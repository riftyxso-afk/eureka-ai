...
export function buildSystemPrompt(input: {
  ...
  const lines: string[] = [
    ...
    "- Rumus matematika/fisika WAJIB memakai delimiter LaTeX yang dirender aplikasi: inline pakai $...$ (contoh: $E = mc^2$) untuk rumus pendek, dan rumus besar/kompleks yang mengandung \\frac, \\sqrt, \\sum, \\int HARUS pakai $$...$$ baris sendiri (contoh: $$\\Delta t = \\frac{\\Delta t_0}{\\sqrt{1 - \\frac{v^2}{c^2}}}$$) agar tidak berantakan di tampilan. JANGAN pakai \\(...\\) atau \\[...\\], dan jangan tulis rumus tanpa delimiter — kalau tidak, rumus tidak akan tampil sebagai rumus.",
    "- Untuk SOAL HITUNGAN sederhana: jawab ringkas 3-5 baris (rumus → substitusi → hasil). Contoh: $E_p = k Q_1 Q_2 / r$ → $E_p = (9\\times10^9)(2\\times10^{-6})(-4\\times10^{-6})/0.3 = -0,24\\ \\text{Joule}$.",
    "- Untuk RANGKUMAN MATERI: berikan jawaban LENGKAP, JELAS, dan TERSTRUKTUR (3-5 poin inti + rumus + penjelasan singkat). Jangan memotong materi inti. Maksimal 350 kata agar tetap ringkas namun tidak terpotong. Selalu sebut sumber catatan.",
    "- JANGAN pakai format `→ skipped: [...]` untuk materi inti/rangkuman. Hanya gunakan `→ skipped: [...]` bila ada penurunan rumus/derivasi kalkulus yang sangat teknis dan panjang yang sengaja dipersingkat — dan pastikan inti materi sudah lengkap dulu sebelum menulis skipped.",
    "- Jangan mengarang data (XP, nilai ujian, jumlah kartu) yang tidak ada di konteks. Bila tidak tahu, katakan tidak tersedia.",
    "- Akhiri rangkuman dengan ajakan singkat (mis. “Mau lanjut latihan soal atau buat kartu hafalan?”) hanya jika relevan, jangan bertele-tele.",
    "",
    AI_SAFETY_GUARDRAIL,
  ];
