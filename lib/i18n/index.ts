...
export const dictionaries = {
  id: {
    ...
    leaderboard: {
      ...
      all: "Semua",
      friends: "Teman",
      desc: "Peringkatmu di antara teman-teman belajar (XP nyata)",
      you: "(Kamu)",
      loading: "Memuat leaderboard...",
      empty: "Belum ada teman di leaderboard. Tambahkan teman di tab Teman!",
    },
    // ── Halaman /dashboard/teman ───────────────────────────
    friends: {
      title: "Teman",
      desc: "Cari teman, kirim undangan, dan belajar bareng",
      searchPlaceholder: "Cari nama teman...",
      searching: "Mencari...",
      relSelf: "Kamu",
      relFriend: "Teman",
      relIncoming: "Menunggu respons kamu",
      relOutgoing: "Menunggu diterima",
      relNone: "Belum berteman",
      accept: "Terima",
      decline: "Tolak",
      add: "Tambah",
      waiting: "⏳ Menunggu",
      noUserTitle: "Tidak ada pengguna bernama",
      noUserDesc:
        "yang terdaftar. Pastikan temanmu sudah membuat akun Eureka.AI, lalu cari dengan nama atau @username-nya.",
      incomingTitle: "Permintaan Masuk ({n})",
      outgoingTitle: "Menunggu Diterima ({n})",
      friendsTitle: "Daftar Teman ({n})",
      wantsToBeFriend: "Ingin berteman denganmu",
      requestPending: "Permintaan menunggu respons",
      emptyFriends: "Belum ada teman. Cari dan undang temanmu di atas!",
      errAdd: "Gagal menambah teman.",
      errRemove: "Gagal menghapus teman.",
      errGeneric: "Terjadi kesalahan. Coba lagi.",
      nowFriends: "{name} sekarang temanmu!",
      requestSent: "Permintaan pertemanan dikirim ke {name}",
      accepted: "{name} diterima sebagai teman!",
      declined: "Permintaan {name} ditolak.",
      confirmRemove: "Hapus {name} dari daftar teman?",
      removed: "{name} dihapus dari daftar teman.",
      deleteFriend: "Hapus {name}",
    },
    // ── Halaman /dashboard/profil ──────────────────────────
    profile: {
      title: "Profil",
      desc: "Kelola data diri dan pengaturan akunmu",
      photoAlt: "Foto profil",
      changePhoto: "Ubah foto profil",
      removePhoto: "Hapus foto profil",
      userNumber: "Pengguna ke-{n}",
      levelTitle: "PELAJAR KONSISTEN",
      totalXp: "Total XP",
      totalNotes: "Total Catatan",
      streak: "Streak",
      referralProgram: "Program Referral",
      rewardClaimed: "Reward Premium sudah kamu dapatkan!",
      inviteGoal: "Ajak {n} teman → Premium 30 hari",
      referralDesc:
        "Bagikan link kamu. Setiap teman yang benar-benar mendaftar lewat link ini dihitung sebagai rujukan — dapatkan Premium 30 hari setelah {n} rujukan valid (sekali pakai).",
      copyRefLink: "Salin link referral",
      shareRefLink: "Bagikan link referral",
      validRefs: "Rujukan valid: {count}/{goal}",
      readyCheck: "Siap! Cek status premium kamu",
      needMore: "Kurang {n} lagi",
      editProfile: "Edit Profil",
      fullName: "NAMA LENGKAP",
      namePlaceholder: "Nama lengkap",
      username: "@USERNAME",
      usernamePlaceholder: "username (dipakai teman untuk mencari kamu)",
      email: "EMAIL",
      emailPlaceholder: "email@contoh.com",
      school: "SEKOLAH",
      schoolPlaceholder: "Nama sekolah",
      grade: "KELAS",
      chooseGrade: "Pilih kelas...",
      education: "JENJANG",
      chooseEducation: "Pilih jenjang...",
      learningProfile: "Profil Belajarmu",
      summaryPsy: "Tipe kepribadian belajar",
      summaryWeak: "Topik paling menantang",
      summaryHabit: "Kebiasaan saat ketemu soal sulit",
      summaryPeak: "Waktu belajar paling fokus",
      summaryEmpty:
        "Analisis belajarmu belum ada. Lengkapi orientasi untuk melihatnya.",
      completeOnboarding: "Lengkapi Orientasi",
      saveChanges: "Simpan Perubahan",
      logout: "Keluar",
      errNameEmpty: "Nama tidak boleh kosong!",
      errUsername: "Username hanya huruf kecil, angka, dan _ (3–20).",
      errSave: "Gagal menyimpan profil.",
      saved: "Profil berhasil disimpan!",
      errPhotoSize: "Foto maksimal 4 MB.",
      photoChanged: "Foto profil diubah! Simpan untuk mengunci.",
      errPhotoLoad: "Gagal memuat foto.",
      photoRemoved: "Foto profil dihapus.",
      refCopied: "Link referral disalin!",
      refCopyFailed: "Gagal menyalin. Salin manual dari kotak di bawah.",
      shareTitle: "Ajak teman belajar di Eureka.AI",
      shareText:
        "Daftar lewat link ini dan dapatkan Premium 30 hari setelah 5 teman bergabung!",
      confirmLogout: "Yakin ingin keluar dari Eureka.AI?",
    },
    // ── Halaman /home ─────────────────────────────────────
    home: {
      hello: "Halo, {name}!",
      chip: "Asisten Belajar Eureka",
      title: "Beranda Eureka",
      subtitle: "Chat dengan AI yang mengenal catatan & progresmu",
      desc:
        "Tanyakan apa saja — Eureka menjawab berdasarkan catatan, bab, subjek, dan progres belajarmu. Ketik",
      descAttach: "untuk melampirkan catatan tertentu.",
      connecting: "Menghubungkan ke Eureka…",
      studyBuddy: "Teman Belajar",
      greetingMorning: "Selamat pagi",
      greetingAfternoon: "Selamat siang",
      greetingEvening: "Selamat sore",
      greetingNight: "Selamat malam",
      featRingkas: "Ringkas Materi",
      featRingkasDesc: "Ringkas catatan belajarmu",
      featRingkasPrompt:
        "Ringkas materi pelajaran yang sedang saya pelajari berdasarkan catatan saya.",
      featAnalogi: "Jelaskan Analogi",
      featAnalogiDesc: "Konsep sulit jadi gampang",
      featAnalogiPrompt:
        "Jelaskan konsep yang sedang saya pelajari dengan analogi sederhana yang mudah dipahami.",
      featRencana: "Rencana Belajar",
      featRencanaDesc: "Siapkan jadwal ujian",
      featRencanaPrompt:
        "Buatkan rencana belajar mingguan untuk persiapan ujian saya.",
      featSoal: "Bantu Soal",
      featSoalDesc: "Langkah demi langkah",
      featSoalPrompt:
        "Bantu saya mengerjakan soal latihan berikut langkah demi langkah.",
      featCards: "Flashcards",
      featCardsDesc: "Buat kartu hafalan dari catatan",
      featCardsPrompt:
        "Buatkan kartu hafalan (flashcards) dari catatan saya untuk dihafal.",
      featKuis: "Kuis Latihan",
      featKuisDesc: "Latihan pilihan ganda",
      featKuisPrompt:
        "Buatkan kuis latihan pilihan ganda dari materi yang sedang saya pelajari.",
      featJadwal: "Jadwal Belajar",
      featJadwalDesc: "Kelola jadwal & rutinitas",
      featLeaderboard: "Leaderboard",
      featLeaderboardDesc: "Lihat peringkat belajarmu",
    },
    // ── Halaman /chat/[id] ────────────────────────────────
    chat: {
      title: "Chat Eureka",
      hasAccess: "Punya akses ke catatan, bab & progresmu",
      copyAll: "Salin chat",
      copied: "Tersalin!",
      copyAllTitle: "Salin seluruh chat sebagai teks bersih",
      shareTitle: "Bagikan chat lewat link publik",
      share: "Bagikan",
      newChat: "Chat baru",
      ...
      you: "Anda",
      eureka: "Eureka",
      emptyTitle: "Halo! Ada yang mau ditanya atau dipelajari?",
      emptyDesc1:
        "Eureka bisa meringkas catatanmu, menjelaskan bab yang sulit, menyusun rencana belajar, atau menjawab soal. Ketik",
      emptyDesc2: "untuk melampirkan catatan.",
      upgrade: "Upgrade ke Pro untuk lanjut",
    },
    // ── Halaman /dashboard/note/[id] ───────────────────────
    note: {
      badgeRangkuman: "Rangkuman",
      badgeMakalah: "Makalah",
      badgeLaporan: "Laporan",
      badgePoin: "Poin Penting",
      chapter: "Bab",
      loading: "Memuat catatan...",
      reading: "Membaca catatanmu...",
      preparingPage: "AI sedang menyiapkan halaman",
      notFound: "Catatan tidak ditemukan",
      notFoundDesc: "Catatan ini mungkin sudah dihapus atau tautannya salah.",
      ...
      viewing: "{n} sedang membuka catatan ini",
      editor: "Editor",
      viewer: "Viewer",
      you: "Kamu",
      summary: "Ringkasan",
      ...
      sourceVideoDesc:
        "Tonton video sambil membaca catatan — Eureka bisa menjawab pertanyaanmu tentang materinya di bagian \"Tanya AI tentang catatannya\".",
      keyPoints: "Poin Penting",
      actionFlashcards: "Flashcards",
      actionQuiz: "Kuis",
      actionComprehension: "Uji Pemahaman",
      actionMindmap: "Mind Map",
      actionDoc: "Dokumen",
      actionShare: "Bagikan",
      comingSoon: "Fitur {feature} segera hadir!",
      aiHighlighting: "Menstabilo...",
      aiHighlight: "Stabilo AI",
      highlightedCount: "{n} bagian distabilo",
      aiHighlightStatus: "AI sedang menstabilo catatanmu...",
      preparingAi: "Menyiapkan AI...",
      expandAll: "Perluas semua bab",
      collapseAll: "Ciutkan semua bab",
      noChapters: "Catatan ini belum memiliki bab.",
      illustrations: "Ilustrasi",
      deleteImage: "Hapus gambar",
      imageAlt: "Ilustrasi catatan",
      rewriteDone: "Catatan berhasil ditulis ulang!",
      rewriteFailed: "Gagal menulis ulang: {error}",
      rewriting: "AI menulis ulang seluruh catatan...",
      imageDeleted: "Ilustrasi dihapus.",
      aiHighlightsApplied: "Stabilo AI diterapkan ({n} bagian)!",
      noNewHighlights: "Tidak ada bagian baru yang layak distabilo.",
      failed: "Gagal: {error}",
      aiHighlightFailed: "Gagal membuat stabilo AI.",
      bookmarkSaved: "Disimpan ke bookmark!",
      bookmarkRemoved: "Bookmark dihapus",
      joinedCollab: "Kamu bergabung sebagai kolaborator!",
      chatSessionFailed: "Gagal membuat sesi chat. Coba lagi ya.",
      deleteFailed: "Gagal menghapus catatan.",
      deleteFailedRetry: "Gagal menghapus catatan. Coba lagi ya.",
      callComingSoon: "Panggilan suara & video call segera hadir!",
      deleteTitle: "Hapus catatan ini?",
      deleteDesc:
        "\"{title}\" akan dihapus permanen beserta semua bab, gambar, kuis, dan kartu hafalannya. Tindakan ini tidak bisa dibatalkan.",
      cancel: "Batal",
      deleting: "Menghapus...",
      deletePermanent: "Hapus Permanen",
      regenTitle: "Tulis ulang seluruh catatan?",
      regenDesc:
        "AI akan menulis ulang semua bab dari \"{title}\" ({n} bab) berdasarkan konten yang ada. Proses ini bisa memakan waktu beberapa menit — kamu bisa menunggu di halaman ini atau membiarkannya jalan.",
      regenDreaming: "AI sedang menulis ulang catatanmu...",
    },
    // ── Halaman /dashboard ──────────────────────────────────
    dashboard: {
      greetingMorning: "Selamat Pagi",
      ...
      greetingEvening: "Selamat Sore",
      greetingNight: "Selamat Malam",
      readyToday: "Siap belajar hari ini?",
      ...
      noNotesDesc:
        "Mulai dengan mengunggah materi belajar pertamamu. AI akan ubah jadi catatan terstruktur.",
      createFirstNote: "Buat Catatan Pertama",
      createNote: "Buat catatan baru",
      justNow: "Baru saja",
      minutesAgo: "{n} mnt lalu",
      todayAt: "Hari ini, {time}",
      confirmDelete:
        "Yakin ingin menghapus catatan ini? Tindakan ini tidak bisa dibatalkan.",
      errDelete: "Gagal menghapus catatan.",
      errDeleteRetry: "Gagal menghapus catatan. Coba lagi ya.",
      errPin: "Gagal menyimpan pin.",
    },
  },
  ...
  en: {
    ...
    leaderboard: {
      ...
      all: "All",
      friends: "Friends",
      desc: "Your rank among study friends (real XP)",
      you: "(You)",
      loading: "Loading leaderboard...",
      empty: "No friends on the leaderboard yet. Add friends in the Friends tab!",
    },
    friends: {
      title: "Friends",
      desc: "Find friends, send invites, and study together",
      searchPlaceholder: "Search friend name...",
      searching: "Searching...",
      relSelf: "You",
      relFriend: "Friend",
      relIncoming: "Waiting for your response",
      relOutgoing: "Waiting to be accepted",
      relNone: "Not friends yet",
      accept: "Accept",
      decline: "Decline",
      add: "Add",
      waiting: "⏳ Waiting",
      noUserTitle: "No user named",
      noUserDesc:
        "is registered. Make sure your friend has an Eureka.AI account, then search by name or @username.",
      incomingTitle: "Incoming Requests ({n})",
      outgoingTitle: "Waiting to be Accepted ({n})",
      friendsTitle: "Friends List ({n})",
      wantsToBeFriend: "Wants to be your friend",
      requestPending: "Request awaiting response",
      emptyFriends: "No friends yet. Search and invite your friends above!",
      errAdd: "Failed to add friend.",
      errRemove: "Failed to remove friend.",
      errGeneric: "Something went wrong. Try again.",
      nowFriends: "{name} is now your friend!",
      requestSent: "Friend request sent to {name}",
      accepted: "{name} accepted as a friend!",
      declined: "Request from {name} declined.",
      confirmRemove: "Remove {name} from your friends?",
      removed: "{name} removed from your friends.",
      deleteFriend: "Remove {name}",
    },
    profile: {
      title: "Profile",
      desc: "Manage your personal info and account settings",
      photoAlt: "Profile photo",
      changePhoto: "Change profile photo",
      removePhoto: "Remove profile photo",
      userNumber: "User #{n}",
      levelTitle: "CONSISTENT LEARNER",
      totalXp: "Total XP",
      totalNotes: "Total Notes",
      streak: "Streak",
      referralProgram: "Referral Program",
      rewardClaimed: "Your Premium reward is already claimed!",
      inviteGoal: "Invite {n} friends → Premium 30 days",
      referralDesc:
        "Share your link. Every friend who actually signs up through it counts as a referral — get Premium 30 days after {n} valid referrals (one-time).",
      copyRefLink: "Copy referral link",
      shareRefLink: "Share referral link",
      validRefs: "Valid referrals: {count}/{goal}",
      readyCheck: "Ready! Check your premium status",
      needMore: "{n} more needed",
      editProfile: "Edit Profile",
      fullName: "FULL NAME",
      namePlaceholder: "Full name",
      username: "@USERNAME",
      usernamePlaceholder: "username (used by friends to find you)",
      email: "EMAIL",
      ...
      chooseEducation: "Choose level...",
      learningProfile: "Your Learning Profile",
      summaryPsy: "Learning personality type",
      summaryWeak: "Most challenging topic",
      summaryHabit: "Habit when facing hard problems",
      summaryPeak: "Peak study time",
      summaryEmpty:
        "No learning analysis yet. Complete onboarding to see it.",
      completeOnboarding: "Complete Onboarding",
      saveChanges: "Save Changes",
      logout: "Log out",
      errNameEmpty: "Name cannot be empty!",
      errUsername: "Username must be lowercase letters, numbers, and _ (3–20).",
      errSave: "Failed to save profile.",
      saved: "Profile saved successfully!",
      errPhotoSize: "Photo must be max 4 MB.",
      photoChanged: "Profile photo changed! Save to lock it in.",
      errPhotoLoad: "Failed to load photo.",
      photoRemoved: "Profile photo removed.",
      refCopied: "Referral link copied!",
      refCopyFailed: "Failed to copy. Copy manually from the box below.",
      shareTitle: "Invite friends to study on Eureka.AI",
      shareText:
        "Sign up through this link and get Premium 30 days after 5 friends join!",
      confirmLogout: "Are you sure you want to log out of Eureka.AI?",
    },
    home: {
      hello: "Hi, {name}!",
      chip: "Eureka Study Assistant",
      title: "Eureka Home",
      subtitle: "Chat with an AI that knows your notes & progress",
      desc:
        "Ask anything — Eureka answers based on your notes, chapters, subjects, and study progress. Type",
      descAttach: "to attach a specific note.",
      connecting: "Connecting to Eureka…",
      studyBuddy: "Study Buddy",
      greetingMorning: "Good morning",
      greetingAfternoon: "Good afternoon",
      greetingEvening: "Good evening",
      greetingNight: "Good night",
      featRingkas: "Summarize Material",
      featRingkasDesc: "Summarize your notes",
      featRingkasPrompt:
        "Summarize the subject I'm currently studying based on my notes.",
      featAnalogi: "Explain with Analogy",
      featAnalogiDesc: "Hard concepts made easy",
      featAnalogiPrompt:
        "Explain the concept I'm studying with a simple, easy-to-understand analogy.",
      featRencana: "Study Plan",
      featRencanaDesc: "Prepare for exams",
      featRencanaPrompt:
        "Create a weekly study plan to prepare for my exam.",
      featSoal: "Help with Questions",
      featSoalDesc: "Step by step",
      featSoalPrompt:
        "Help me solve the following practice questions step by step.",
      featCards: "Flashcards",
      featCardsDesc: "Make flashcards from notes",
      featCardsPrompt:
        "Create flashcards from my notes to memorize.",
      featKuis: "Practice Quiz",
      featKuisDesc: "Multiple-choice practice",
      featKuisPrompt:
        "Create a multiple-choice practice quiz from what I'm currently studying.",
      featJadwal: "Study Schedule",
      featJadwalDesc: "Manage schedule & routine",
      featLeaderboard: "Leaderboard",
      featLeaderboardDesc: "See your study ranking",
    },
    chat: {
      title: "Chat Eureka",
      hasAccess: "Access to your notes, chapters & progress",
      copyAll: "Copy chat",
      copied: "Copied!",
      copyAllTitle: "Copy entire chat as clean text",
      shareTitle: "Share chat via public link",
      share: "Share",
      newChat: "New chat",
      ...
      you: "You",
      eureka: "Eureka",
      emptyTitle: "Hi! Anything you'd like to ask or learn?",
      emptyDesc1:
        "Eureka can summarize your notes, explain difficult chapters, build a study plan, or answer questions. Type",
      emptyDesc2: "to attach a note.",
      upgrade: "Upgrade to Pro to continue",
    },
    note: {
      badgeRangkuman: "Summary",
      badgeMakalah: "Paper",
      badgeLaporan: "Report",
      badgePoin: "Key Points",
      chapter: "Chapter",
      loading: "Loading note...",
      reading: "Reading your note...",
      preparingPage: "AI is preparing the page",
      notFound: "Note not found",
      notFoundDesc: "This note may have been deleted or the link is wrong.",
      ...
      viewing: "{n} are viewing this note",
      editor: "Editor",
      viewer: "Viewer",
      you: "You",
      summary: "Summary",
      ...
      sourceVideoDesc:
        "Watch the video while reading the note — Eureka can answer your questions about it in the \"Ask AI about this note\" section.",
      keyPoints: "Key Points",
      actionFlashcards: "Flashcards",
      actionQuiz: "Quiz",
      actionComprehension: "Comprehension Test",
      actionMindmap: "Mind Map",
      actionDoc: "Document",
      actionShare: "Share",
      comingSoon: "Feature \"{feature}\" coming soon!",
      aiHighlighting: "Highlighting...",
      aiHighlight: "AI Highlight",
      highlightedCount: "{n} parts highlighted",
      aiHighlightStatus: "AI is highlighting your note...",
      preparingAi: "Preparing AI...",
      expandAll: "Expand all chapters",
      collapseAll: "Collapse all chapters",
      noChapters: "This note has no chapters yet.",
      illustrations: "Illustrations",
      deleteImage: "Delete image",
      imageAlt: "Note illustration",
      rewriteDone: "Note rewritten successfully!",
      rewriteFailed: "Failed to rewrite: {error}",
      rewriting: "AI is rewriting the entire note...",
      imageDeleted: "Illustration deleted.",
      aiHighlightsApplied: "AI highlights applied ({n} parts)!",
      noNewHighlights: "No new parts worth highlighting.",
      failed: "Failed: {error}",
      aiHighlightFailed: "Failed to create AI highlights.",
      bookmarkSaved: "Saved to bookmarks!",
      bookmarkRemoved: "Bookmark removed",
      joinedCollab: "You joined as a collaborator!",
      chatSessionFailed: "Failed to create chat session. Try again.",
      deleteFailed: "Failed to delete note.",
      deleteFailedRetry: "Failed to delete the note. Please try again.",
      callComingSoon: "Voice & video calls coming soon!",
      deleteTitle: "Delete this note?",
      deleteDesc:
        "\"{title}\" will be permanently deleted along with all chapters, images, quizzes, and flashcards. This action cannot be undone.",
      cancel: "Cancel",
      deleting: "Deleting...",
      deletePermanent: "Delete Permanently",
      regenTitle: "Rewrite the entire note?",
      regenDesc:
        "AI will rewrite all chapters of \"{title}\" ({n} chapters) based on existing content. This may take a few minutes — you can wait on this page or let it run.",
      regenDreaming: "AI is rewriting your note...",
    },
    dashboard: {
      greetingMorning: "Good Morning",
      greetingAfternoon: "Good Afternoon",
      greetingEvening: "Good Evening",
      greetingNight: "Good Night",
      readyToday: "Ready to learn today?",
      startLearning: "Start Learning",
      devBanner:
        "Development version — some features may not work optimally yet.",
      ...
      studyPlanDesc:
        "Plan your week — fold by fold toward your goals",
      open: "Open →",
      ...
      noNotesDesc:
        "Start by uploading your first study material. AI will turn it into structured notes.",
      ...
      errDelete: "Failed to delete note.",
      errDeleteRetry: "Failed to delete the note. Please try again.",
      errPin: "Failed to save pin.",
    },
  },
} as const;
